...
const Future = () => {        
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Hər addımda keyfiyyətli və etibarlı xidmət</h2>
            <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">Azturk.net ilə internet və televiziya təcrübənizi yüksəldin</p>
        </div>

        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            <div className="md:p-8 lg:p-14 bg-indigo-500">
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Sürətli Satış</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Ən son texnologiyalar ilə təchiz olunmuş xidmətimizdən faydalanın. Azturk.net ilə onlayn alış-verişinizi sürətləndirin.</p>
            </div>

            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 bg-indigo-500">
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Məhsul Keyfiyyəti</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">İnternet və televiziya sahəsində keyfiyyətli məhsullar təqdim edirik. Hər zaman ən yaxşısı üçün buradayıq.</p>
            </div>

            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t bg-indigo-500">
                <svg className="mx-auto" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Əhatə dairəsi</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Şəhərinizdə ən geniş əhatə dairəsinə sahib internet və televiziya xidməti təqdim edirik. Hər zaman bağlı qalın!</p>
            </div>
        </div>
    </div>
</section>
